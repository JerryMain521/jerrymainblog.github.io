(() => {
    var e = {
            416(e) {
                ...
                var D = Object.freeze({
                    ...
                    SHEBANG: (e = {}) => {
                        const n = /^#![ ]*\//;
                        return e.binary && (e.begin = m(n, /.*\b/, e.binary, /\b.*/)), a({
                            scope: "meta",
                            begin: n,
                            end: /$/,
                            relevance: 0,
                ...
                function ee(e, n, {
                    ...
                    const a = e[t],
                        r = {},
                        s = {};
                    for (let e = 1; e <= n.length; e++) s[e + i] = a[e], r[e + i] = !0, i += h(n[e - 1]);
                    ...
                    ! function(e) {
                        ...
                        function(e) {
                            if (Array.isArray(e.begin)) {
                                if (e.skip || e.excludeBegin || e.returnBegin) throw J("skip, excludeBegin, returnBegin not compatible with beginScope: {}"), Y;
                                if ("object" != typeof e.beginScope || null === e.beginScope) throw J("beginScope must be object"), Y;
                                ee(e, e.begin, {
                                    key: "beginScope"
                                }), e.begin = _(e.begin, {
                                    joinWith: ""
                        ...
                        function(e) {
                            if (Array.isArray(e.end)) {
                                if (e.skip || e.excludeEnd || e.returnEnd) throw J("skip, excludeEnd, returnEnd not compatible with endScope: {}"), Y;
                                if ("object" != typeof e.endScope || null === e.endScope) throw J("endScope must be object"), Y;
                                ee(e, e.end, {
                                    key: "endScope"
                                }), e.end = _(e.end, {
                                    joinWith: ""
                ...
                function te(e) {
                    ...
                    class t {
                        ...
                        addRule(e, n) {
                            n.position = this.position++, this.matchIndexes[this.matchAt] = n, this.regexes.push([n, e]), this.matchAt += h(e) + 1
                        }
                        compile() {
                            0 === this.regexes.length && (this.exec = () => null);
                            const e = this.regexes.map(e => e[1]);
                            this.matcherRe = n(_(e, {
                                joinWith: "|"
                            }), !0), this.lastIndex = 0
                        }
                        exec(e) {
                    ...
                    return e.classNameAliases = a(e.classNameAliases || {}),
                        function t(r, s) {
                            ...
                            [P, H, ne, K].forEach(e => e(r, s)), e.compilerExtensions.forEach(e => e(r, s)), r.__beforeBegin = null, [U, F, q].forEach(e => e(r, s)), r.isCompiled = !0;
                            let l = null;
                            return "object" == typeof r.keywords && r.keywords.$pattern && (r.keywords = Object.assign({}, r.keywords), l = r.keywords.$pattern, delete r.keywords.$pattern), l = l || /\w+/, r.keywords && (r.keywords = Z(r.keywords, e.case_insensitive)), o.keywordPatternRe = n(l, !0), s && (r.begin || (r.begin = /\B|\b/), o.beginRe = n(o.begin), r.end || r.endsWithParent || (r.end = /\B|\b/), r.end && (o.endRe = n(o.end)), o.terminatorEnd = d(o.end) || "", r.endsWithParent && s.terminatorEnd && (o.terminatorEnd += (r.end ? "|" : "") + s.terminatorEnd)), r.illegal && (o.illegalRe = n(r.illegal)), r.contains || (r.contains = []), r.contains = [].concat(...r.contains.map(function(e) {
                                return function(e) {
                                    ...
                                    })), e.cachedVariants ? e.cachedVariants : ie(e) ? a(e, {
                                        starts: e.starts ? a(e.starts) : null
                                    }) : Object.isFrozen(e) ? a(e) : e
                                }("self" === e ? r : e)
                            })), r.contains.forEach(function(e) {
                                t(e, o)
                            }), r.starts && t(r.starts, s), o.matcher = function(e) {
                                const n = new i;
                ...
                const re = i,
                    ...
                    le = function(e) {
                        ...
                        function b(e, n, t) {
                            let i = "",
                                a = "";
                            "object" == typeof n ? (i = e, t = n.ignoreIllegals, a = n.language) : (V("10.7.0", "highlight(lang, code, ...args) has been deprecated."), V("10.7.0", "Please use highlight(code, options) instead.\nhttps://github.com/highlightjs/highlight.js/issues/2277"), a = e, i = n), void 0 === t && (t = !0);
                            const r = {
                                code: i,
                                language: a
                            };
                        ...
                        function _(e, n, a, r) {
                            ...
                            function g() {
                                if (!A.keywords) return void S.addText(M);
                                let e = 0;
                                A.keywordPatternRe.lastIndex = 0;
                                let n = A.keywordPatternRe.exec(M),
                                    t = "";
                                for (; n;) {
                                    t += M.substring(e, n.index);
                                    const i = E.case_insensitive ? n[0].toLowerCase() : n[0],
                                        a = c(A, i);
                                    if (a) {
                                        const [e, r] = a;
                                        if (S.addText(t), t = "", l[i] = (l[i] || 0) + 1, l[i] <= 7 && (C += r), e.startsWith("_")) t += n[0];
                                        else {
                                            const t = E.classNameAliases[e] || e;
                                            p(n[0], t)
                                        }
                                    } else t += n[0];
                                    e = A.keywordPatternRe.lastIndex, n = A.keywordPatternRe.exec(M)
                                }
                            ...
                            function u() {
                                null != A.subLanguage ? function() {
                                    ...
                                    if ("string" == typeof A.subLanguage) {
                                        if (!i[A.subLanguage]) return void S.addText(M);
                                        e = _(A.subLanguage, M, !0, O[A.subLanguage]), O[A.subLanguage] = e._top
                                    } else e = y(M, A.subLanguage.length ? A.subLanguage : null);
                                    A.relevance > 0 && (C += e.relevance), S.__addSublanguage(e._emitter, e.language)
                                }() : g(), M = ""
                            }
                            ...
                            function f(e, n) {
                                return e.scope && "string" == typeof e.scope && S.openNode(E.classNameAliases[e.scope] || e.scope), e.beginScope && (e.beginScope._wrap ? (p(M, E.classNameAliases[e.beginScope._wrap] || e.beginScope._wrap), M = "") : e.beginScope._multi && (m(e.beginScope, n), M = "")), A = Object.create(e, {
                                    parent: {
                                        value: A
                                    }
                                }), A
                            ...
                            function h(e, n, i) {
                                ...
                                if (e.endsWithParent) return h(e.parent, n, i)
                            }

                            function b(e) {
                                return 0 === A.matcher.regexIndex ? (M += e[0], 1) : (L = !0, 0)
                            }
                            ...
                            function w(e) {
                                ...
                                if (!a) return oe;
                                const r = A;
                                A.endScope && A.endScope._wrap ? (u(), p(t, A.endScope._wrap)) : A.endScope && A.endScope._multi ? (u(), m(A.endScope, e)) : r.skip ? M += t : (r.returnEnd || r.excludeEnd || (M += t), u(), r.excludeEnd && (M = t));
                                do {
                                    A.scope && S.closeNode(), A.skip || A.subLanguage || (C += A.relevance), A = A.parent
                                } while (A !== a.parent);
                            ...
                            function x(i, r) {
                                ...
                                if (v = r, "begin" === r.type) return function(e) {
                                    const n = e[0],
                                        i = e.rule,
                                        a = new t(i),
                                        r = [i.__beforeBegin, i["on:begin"]];
                                    for (const t of r)
                                        if (t && (t(e, a), a.isMatchIgnored)) return b(n);
                                    return i.skip ? M += n : (i.excludeBegin && (M += n), u(), i.returnBegin || i.excludeBegin || (M = n)), f(i, e), i.returnBegin ? 0 : n.length
                                }(r);
                                if ("illegal" === r.type && !a) {
                                    const e = new Error('Illegal lexeme "' + o + '" for mode "' + (A.scope || "<unnamed>") + '"');
                                    throw e.mode = A, e
                                }
                                if ("end" === r.type) {
                                    const e = w(r);
                            ...
                            ! function() {
                                const e = [];
                                for (let n = A; n !== E; n = n.parent) n.scope && e.unshift(n.scope);
                            ...
                            let M = "",
                                ...
                                L = !1;
                            try {
                                if (E.__emitTokens) E.__emitTokens(n, S);
                                else {
                                    for (A.matcher.considerAll();;) {
                                        R++, L ? L = !1 : A.matcher.considerAll(), A.matcher.lastIndex = T;
                                        const e = A.matcher.exec(n);
                                        if (!e) break;
                                        const t = x(n.substring(T, e.index), e);
                                        T = e.index + t
                                    }
                                    x(n.substring(T))
                                }
                                return S.finalize(), N = S.toHTML(), {
                                    language: e,
                                    value: N,
                                    relevance: C,
                                    illegal: !1,
                        ...
                        function y(e, n) {
                            ...
                            const t = function(e) {
                                ...
                                a = n.filter(k).filter($).map(n => _(n, e, !1));
                            a.unshift(t);
                            const r = a.sort((e, n) => {
                                    if (e.relevance !== n.relevance) return n.relevance - e.relevance;
                                    if (e.language && n.language) {
                                        if (k(e.language).supersetOf === n.language) return 1;
                                        if (k(n.language).supersetOf === e.language) return -1
                                    }
                                    return 0
                                }),
                                [s, o] = r,
                        ...
                        function w(e) {
                            ...
                            const t = function(e) {
                                ...
                                return n.split(/\s+/).find(e => h(e) || k(e))
                            }(e);
                            if (h(t)) return;
                            ...
                            e.innerHTML = r.value, e.dataset.highlighted = "yes",
                                function(e, n, t) {
                                    const i = n && a[n] || t;
                        ...
                        function x() {
                            if ("loading" === document.readyState) return v || window.addEventListener("DOMContentLoaded", function() {
                                x()
                            }, !1), void(v = !0);
                        ...
                        Object.assign(e, {
                            ...
                            initHighlighting: () => {
                                x(), V("10.6.0", "initHighlighting() deprecated.  Use highlightAll() now.")
                            },
                            initHighlightingOnLoad: function() {
                                x(), V("10.6.0", "initHighlightingOnLoad() deprecated.  Use highlightAll() now.")
                            },
                            registerLanguage: function(n, t) {
                                ...
                                a.name || (a.name = n), i[n] = a, a.rawDefinition = t.bind(null, e), a.aliases && E(a.aliases, {
                                    languageName: n
                                })
                            },
    ...
    function t(i) {
        ...
        const e = t(416),
            ...
            i = ["as", "in", "of", "if", "for", "while", "finally", "var", "new", "function", "do", "return", "void", "else", "break", "catch", "instanceof", "with", "throw", "case", "default", "try", "switch", "continue", "typeof", "delete", "let", "yield", "const", "class", "debugger", "async", "await", "static", "import", "from", "export", "extends", "using"],
        ...
        e.registerLanguage("javascript", function(e) {
            const t = e.regex,
                ...
                k = [e.APOS_STRING_MODE, e.QUOTE_STRING_MODE, _, y, w, v, {
                    match: /\$\d+/
                }, h];
            b.contains = k.concat({
                begin: /\{/,
            ...
            const E = [].concat(x, b.contains),
                ...
                A = {
                    variants: [{
                        match: [/class/, /\s+/, d, /\s+/, /extends/, /\s+/, t.concat(d, "(", t.concat(/\./, d), ")*")],
                        scope: {
                            1: "keyword",
                            3: "title.class",
                            5: "keyword",
                ...
                M = {
                    match: t.concat(/\b/, (C = [...o, "super", "import"].map(e => `${e}\\s*\\(`), t.concat("(?!", C.join("|"), ")")), d, t.lookahead(/\s*\(/)),
            ...
            const T = {
                ...
                B = {
                    match: [/const|var|let/, /\s+/, d, /\s*/, /=\s*/, /(async\s*)?/, t.lookahead(L)],
                    keywords: "async",
                    className: {
                        1: "keyword",
                        3: "title.function"
            ...
            return {
                ...
                contains: [e.SHEBANG({
                ...
                }, e.APOS_STRING_MODE, e.QUOTE_STRING_MODE, _, y, w, v, x, {
                    match: /\$\d+/
                }, h, O, {
                    scope: "attr",
                    match: d + t.lookahead(":"),
                    ...
                    returnBegin: !0,
                    label: "func.def",
                    contains: [N, e.inherit(e.TITLE_MODE, {
                        begin: d,
                        className: "title.function"
                    })]
                }, {
            ...
            const n = e.regex,
                ...
                m = [p, c, s, t, e.C_BLOCK_COMMENT_MODE, l, o],
                f = {
                    variants: [{
                        begin: /=/,
                        end: /;/
        ...
        }), e.registerLanguage("c", function(e) {
            const n = e.regex,
                t = e.COMMENT("//", "$", {
                    contains: [{
                        begin: /\\\n/
                ...
                p = [c, s, t, e.C_BLOCK_COMMENT_MODE, l, o],
                m = {
                    variants: [{
                        begin: /=/,
                        end: /;/
        ...
        }), e.registerLanguage("xml", f), e.registerLanguage("html", f), e.registerLanguage("json", function(e) {
            ...
            return d.contains = [a, r, s, l, c, g, p].concat(o), {
                name: "Scheme",
                aliases: ["scm"],
                illegal: /\S/,
                contains: [e.SHEBANG(), r, s, c, g, p].concat(o)
            }
        }), e.registerLanguage("verilog", function(e) {
            const n = e.regex,
                t = ["begin_keywords", "celldefine", "default_nettype", "default_decay_time", "default_trireg_strength", "define", "delay_mode_distributed", "delay_mode_path", "delay_mode_unit", "delay_mode_zero", "else", "elsif", "end_keywords", "endcelldefine", "endif", "ifdef", "ifndef", "include", "line", "nounconnected_drive", "pragma", "resetall", "timescale", "unconnected_drive", "undef", "undefineall"];
            return {
                name: "Verilog",
                aliases: ["v", "sv", "svh"],
                case_insensitive: !1,
